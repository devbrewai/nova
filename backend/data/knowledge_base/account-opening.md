...
5. Set up your login credentials and two-factor authentication
6. Fund your account with an initial deposit (minimum $0 — no minimum balance required)

## Account Activation

Most accounts are verified and activated within 5 minutes. In some cases, additional verification may take up to 2 business days. You will receive an email and push notification when your account is ready.

## Initial Setup

Once your account is active, we recommend:
