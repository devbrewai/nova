...
**Sending to an external bank:**
- Standard processing: 1-3 business days
- Same-day ACH: Available for transfers initiated before 2:00 PM ET on business days. $2 fee for Standard accounts; free for Premium accounts.
...
- Outgoing: Same business day if initiated before 3:00 PM ET. Next business day if initiated after 3:00 PM ET or on weekends.
- Incoming: Typically received within a few hours during business hours.

**International wire transfers:**
- 1-5 business days depending on the destination country and intermediary banks involved
...
Track the status of any transfer in real time: go to Transactions > find the transfer > View Status. Statuses include: Initiated, Processing, In Transit, Completed, Failed, and Returned.
